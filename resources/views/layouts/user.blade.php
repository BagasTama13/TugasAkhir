...
<head>
    ...
    <meta name="description" content="BPTrans — Hub pelanggan untuk memesan material konstruksi premium dan melacak pengiriman.">
    ...
    {{-- Per-page styles (Leaflet CSS, etc.) loaded only when needed --}}
    @stack('styles')
...
<body class="h-full text-slate-900 antialiased bg-slate-50/50 overflow-x-hidden selection:bg-indigo-500 selection:text-white">
    ...
    @livewireScripts
    {{-- Per-page scripts (Leaflet JS, Midtrans Snap, etc.) loaded only when needed --}}
    @stack('scripts')
</body>
</html>
